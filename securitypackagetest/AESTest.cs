...
namespace SecurityPackageTest
{
    ...
    public class AESTestm 
    {
        ...
        public void print(string target, string output)
        {
            StreamWriter sw = new StreamWriter("D:\\Courses\\4th year\\2nd term\\Computer & Network Security\\Labs\\test.txt");
            sw.WriteLine(target);
            sw.WriteLine(output);
            sw.Close();
        }
